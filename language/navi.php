...
$txt['m_home'] = 'Kelku';
$txt['m_sounds'] = 'Ayfam';
$txt['m_lessons'] = 'Aysänumvi';
$txt['m_links'] = 'Aysätare';
$txt['m_downloads'] = 'Ayu';
$txt['m_rss'] = 'Fmawn';
// home
$txt['h_welcome'] = 'Zola\'u Nìprrte\'';
$txt['h_title'] = 'Aysänumvi Aftue';
$txt['h_welcome_txt'] = 'Zola\'u nìprrte\' ne Tirea Na\'vi! Fìweptseng fkeytok fte Lì\'fyat leNa\'vi kivar frapor nìftue.
    Sunu Uniltìrantokx a ayngari a ke smon nìtxan fya\'o aylì\'fyayä, kan oe srung sivi ayngar fte tsivun aynga slivu haya
    plltxeyu fìlì\'fyayä akosman. -- Tirea Aean';
$txt['h_get_st'] = 'Sngä\'i ko';
// sounds
...
// links
$txt['l_links'] = 'Aysätare';
$txt['l_cool'] = 'Wepseng a lu sìltsan';
$txt['l_blogs'] = 'Fìlok leNa&#39;vi a oel inan';
$txt['l_navi_gen'] = 'Ngopyu Aystxoä leNa\'vi';
$txt['l_valid_gen'] = 'Aystxoti akangay ngop';
// downloads
$txt['d_downl'] = 'Fuk sì famrel';
...
$txt['g_first_name'] = '\'Awvea Tstxoä ngimpup';
$txt['g_family_name'] = 'Soaiä Tstxoä ngimpup';
$txt['g_parent_name'] = 'Sa\'nokä fu Sempulä Tstxoä ngimpup';
$txt['g_number_of_name'] = 'Holpxay tstxoä a nga new ngivop';
$txt['g_credits'] = '<a href="http://forum.learnnavi.org/index.php?msg=566249">
      Ngopyu leNa\'via Aystxoä a mì Ìnternet!
    </a> ta Uniltìrantokx te Skxawng';
$txt['g_generate'] = 'Ngop!';
// about
$txt['a_creator'] = 'Ngopyu lì\'fyayä';
$txt['a_developers'] = 'Ayngopyu fìweptsengä alu Tirea Na\'vi';
$txt['a_thanks'] = 'Zeya irayo';
$txt['a_others'] = 'saylahe!';
$txt['a_3rdparty'] = 'Lahea tuteyä tìkangkemvi a solar ayngopyul fìtsengä';
$txt['a_mit'] = 'Tsun nga sivar ìlä MIT Horen (MIT)';
// rss
