...
<!-- DOn't forget to delete one of the "../" -->
  ...
  <br><br>
	...
	<blockquote>
		...
		<br />
		<i>
			I <span class="green-text">hunt</span><span class="blue-text">ed</span> hexapede.
		</i>
		<br />
		<br />
		<strong>
			<span class="green-text">t</span><span class="blue-text">ìm</span><span class="green-text">aron</span> oel yerikit
		</strong>
		<br />
		<i>
			I <span class="blue-text">just</span> <span class="green-text">hunt</span><span class="blue-text">ed</span> hexapede.
		</i>
	</blockquote>
	<p>
	...
	<blockquote>
		<strong>
			Oel teyluti <span class="green-text">y</span><span class="blue-text">ay</span><span class="green-text">om</span>.
		</strong>
		<br />
		<i>
			I <span class="blue-text">will</span> <span class="green-text">eat</span> teylu.
		</i>
		<br />
		<br />
		<strong>
			Poan <span class="green-text">srung s</span><span class="blue-text">ìy</span><span class="green-text">i</span> oeru.
		</strong>
		<br />
		<i>
